...
public class TextAdventurePrototypeUI {
    ...
    JLabel titleNameLabel, hpLabel, hpLabelNumber, weaponLabel, weaponLabelName, strengthLabel,
            strengthLabelNumber, intelligenceLabel, intelligenceLabelName, dexterityLabel, dexterityLabelName, charismaLabel,
            charismaLabelName;
    ...
    public void CreateUI(ChoiceHandler cHandler) {
        ...
        titleNamePanel.setBounds(350, 100, 750, 175);// place a panel that displays the name of the title
        titleNamePanel.setBackground(Color.BLACK);
        titleNameLabel = new JLabel("Prototype Game");
