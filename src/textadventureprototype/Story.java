...
public class Story {
     ...
     * );
     * UI.choice1.
     * setText("I am not ready to face him yet. Perhaps a browse through the place is in order first."
     * );
     ...
     * 
     * }
     * // shorter(because I don't feel like writing a story for it anymore, and
     * modify
     * // the graphs in case I have any sanity left. Also, upload the new vertices
     * and
     * // ask Vesko whether we can make the game not travel from one verice to
     * another
     ...
     * );
     * UI.choice1.
     * setText("'Still, I have something I would like to learn some more information about...'"
     * );
     * UI.choice2.setText("'I have to go, never mind.'");
     * UI.choice3.setText("");
     * UI.choice4.setText("");
     ...
     * );
     * UI.choice1.
     * setText("Stay awhile and listen for a little longer. He might say something of use."
     * );
     * UI.choice2.setText(
     ...
     * );
     * UI.choice1.
     * setText("'As I was saying, I need some information. About a monster I'm hunting. Help me find it."
     * );
     * UI.choice2.setText(
     * "Enough of this. I need something and I cannot afford to listen any more of this creature's ramblings..."
     * );
     ...
     * );
     * UI.choice1.
     * setText("'Now, listen to me carefully and answer briefly if want to live.'");
     * UI.choice2.setText(
     ...
     * UI.mainTextArea.
     * setText("The man gazes you coldly. A simple, yet hard 'NO' escapes his lips"
     * );
     ...
     * UI.mainTextArea.
     * setText("His look remains unyielding. His answer isn't changing anytime soon."
     * );
